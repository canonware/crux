...
cdef class SymbolSpec:
    cdef readonly str name
    cdef readonly object prec # Precedence or str.
...
cdef class NontermSpec(SymbolSpec):
    cdef readonly str qualified
    cdef readonly type nontermType
    cdef readonly list chain # [%nonterm, %extends, ..., %extends]
